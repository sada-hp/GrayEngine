...
#define HWIN_TITLE L"GrayEngineWorldEditor"
...
LRESULT CALLBACK HostWindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_SIZE: //// Resize WPF Control on Host Window Resizing
        ...
        break;
	case 0x1200:
		Logger::Out("You've got a mail! %s", OutputColor::Yellow, lParam);
		break;
    default:
...
int main(int argc, char** argv)
{
	...
	HostWindowClass.lpszClassName = (LPCSTR)cpphwinCN; HostWindowClass.lpszMenuName = NULL;
